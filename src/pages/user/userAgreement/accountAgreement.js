    ...
    render(){
        ...
        return(
            <div className={styles.agreementBox}>
                <div class="content">
                    <h2 className={styles.aTitle}>智赛棋牌账号规则</h2>
                    <p>尊敬的智赛棋牌用户：</p>
                    <p style={{textIndent:'2em'}}>欢迎您使用智赛棋牌的服务！<strong>为有效利用智赛棋牌号码资源，维护用户合法权益，特制订《智赛棋牌号码规则》（以下简称“本规则”），同时您应当阅读并遵守<a href="#">《智赛棋牌服务协议》</a>。请您务必审慎阅读、充分理解各条款内容，特别是免除或者限制智赛棋牌责任的条款、对用户权利进行限制的条款、约定争议解决方式和司法管辖的条款等，以及开通或使用某项服务的单独协议或规则。限制、免责条款或者其他涉及您重大权益的条款可能以加粗、加下划线等形式提示您重点注意。</strong></p>
