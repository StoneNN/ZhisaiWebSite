    ...
    render(){
        ...
        return(
            <div className={styles.agreementBox}>
                <div class="content">
                    <h2 className={styles.aTitle}>智赛棋牌服务协议</h2>
                    <p>尊敬的智赛棋牌用户：</p>
                    <p style={{textIndent:'2em'}}>欢迎您使用智赛棋牌的服务！为使用智赛棋牌的服务，您应当阅读并遵守《智赛棋牌服务协议》（以下简称“本协议”）和 <Link to='/user/userAgreement/accountAgreement'>《智赛棋牌账号规则》</Link>。请您务必审慎阅读、充分理解各条款内容，特别是免除或者限制智赛棋牌责任的条款、对用户权利进行限制的条款、约定争议解决方式和司法管辖的条款（如第十八条相关约定）等，以及开通或使用某项服务的单独协议或规则。限制、免责条款或者其他涉及您重大权益的条款可能以加粗、加下划线等形式提示您重点注意。</p>
                    <p style={{textIndent:'2em'}}><strong>除非您已充分阅读、完全理解并接受本协议所有条款，否则您无权使用智赛棋牌服务。您点击“同意”或“下一步”，或您使用智赛棋牌服务，或者以其他任何明示或者默示方式表示接受本协议的，均视为您已阅读并同意签署本协议。本协议即在您与智赛棋牌之间产生法律效力，成为对双方均具有约束力的法律文件。</strong></p>
                    ...
                    <h4><strong> 1.3本协议内容同时包括<Link to='/user/userAgreement/accountAgreement'>《智赛棋牌账号规则》</Link>,且您在使用智赛棋牌某一特定服务时，该服务可能会另有单独的协议、相关业务规则等（以下统称为“单独协议”）。上述内容一经正式发布，即为本协议不可分割的组成部分，您同样应当遵守。您对前述任何单独协议的接受，即视为您对本协议全部的接受。您对本协议的接受，即视为您对<Link to='/user/userAgreement/accountAgreement'>《智赛棋牌账号规则》</Link>的接受。</strong></h4>
                    ...
                    <h3>三、【用户个人信息保护】</h3>
                    <p><strong>3.1 保护用户个人信息是智赛棋牌的一项基本原则。智赛棋牌将按照本协议及<Link to='/user/userAgreement/accountAgreement'>《智赛棋牌账号规则》</Link>的规定收集、使用、储存和分享您的个人信息。本协议对个人信息保护相关内容未作明确规定的，均应以<Link to='/user/userAgreement/accountAgreement'>《智赛棋牌账号规则》</Link>的内容为准。</strong></p>
		            ...
		            <p><strong>（4）依据<Link to='/user/userAgreement/accountAgreement'>《智赛棋牌账号规则》</Link>或其他相关协议规则可以转移或披露给任何第三方的情形。</strong></p>
                    ...
                    <h3>十二、【主权利义务条款】</h3>
                    <h4>12.1账号使用规范</h4>
                    <p>12.1.1 智赛棋牌的账户即您的个人帐户。应使用您拥有合法使用权的智赛棋牌账号，并遵守<Link to='/user/userAgreement/accountAgreement'>《智赛棋牌账号规则》</Link>、《智赛棋牌软件许可及服务协议》及相关协议、规则等的约束。 同时，您承担以前述全部智赛棋牌账号为标识进行的全部行为的法律责任。 </p>
                    ...
                    <p><strong></strong> 20.1您通过本服务发送或传播的内容（包括但不限于网页、文字、图片、音频、视频、图表等）均由您自行承担责任。</p>
                    <p><strong></strong>20.2您发送或传播的内容应有合法来源，相关内容为您所有或您已获得必要的授权。</p>
                    <p><strong></strong>20.3如果您发送或传播的内容违法违规或侵犯他人权利的，智赛棋牌有权进行独立判断并采取删除、屏蔽或断开链接等措施。</p>
                    <p><strong></strong>20.4如您被他人投诉或您投诉他人，智赛棋牌有权将争议中相关方的主体信息、联系方式、投诉相关内容等必要信息提供给相关当事方或相关部门，以便及时解决投诉纠纷，保护各方合法权益。</p>
                    <p><strong></strong> 20.5您保证对您在投诉处理程序中提供的信息、材料、证据等的真实性、合法性、有效性负责。</p>
		
                    <h3>二十一、【不可抗力及其他免责事由】</h3>
                    <p><strong>21.1您理解并同意，在使用本服务的过程中，可能会遇到不可抗力等风险因素，使本服务受到影响。不可抗力是指不能预见、不能克服并不能避免且对一方或双方造成重大影响的客观事件，包括但不限于自然灾害如洪水、地震、瘟疫流行和风暴等以及社会事件如战争、动乱、政府行为等。出现上述情况时，智赛棋牌将努力在第一时间与相关单位配合，争取及时进行处理，但是由此给您造成的损失智赛棋牌在法律允许的范围内免责。</strong></p>
                    <p>
                    ...
                    <p><strong>23.1您理解并同意，智赛棋牌基于经营策略的调整，可能会对服务内容进行变更，也可能会中断、中止或终止服务。</strong></p>
                    <p>
                    ...
                    <h3>二十六、【其他】</h3>
                    <p>26.1如果您对本协议或本服务有意见或建议，可与智赛棋牌客户服务部门联系，我们会给予您必要的帮助。（正文完）
                    </p>
